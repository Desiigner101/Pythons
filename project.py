...
# madlib = (f"hey did you know that programming is not {adj}, it is perhaps {adj2}. just maintain your grind and keep on going \
# because everything will have a {word} and you will {word2} very much")
# print (madlib)
...
# good programmer starts with hope in your mind and a dream in your TEST. Through blood, \
